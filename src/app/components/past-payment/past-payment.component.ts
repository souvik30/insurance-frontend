...
@Component({
  selector: 'app-past-payment',
  templateUrl: './past-payment.component.html',
  styleUrls: ['./past-payment.component.css']
})
export class PastPaymentComponent implements OnInit {
  searchValue!: string;
  noDataDisplay='';
  fetchedData:any;
  data=false;
